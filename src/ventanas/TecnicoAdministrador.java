 ...
 * @author Ernesto
 */
public class TecnicoAdministrador extends javax.swing.JFrame {
    
    String user, nombre_usuario;
    int sesion_usuario;

 
    public TecnicoAdministrador() {
        initComponents();
        user = Login.user;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 120, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TecnicoAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TecnicoAdministrador().setVisible(true);
            }
        });
    }
