...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Titulo.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 36)); // NOI18N
        ...
        getContentPane().add(jLabel_Nombre4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, -1, -1));
        ...
        txt_mail.setBackground(new java.awt.Color(255, 255, 204));
        ...
        getContentPane().add(txt_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 210, -1));

        txt_RegistradoPor.setBackground(new java.awt.Color(255, 255, 204));
        ...
        getContentPane().add(txt_RegistradoPor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 210, -1));

        cmb_estatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo" }));
        getContentPane().add(cmb_estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 260, -1, -1));

        cmb_niveles.setBackground(new java.awt.Color(255, 255, 204));
        cmb_niveles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Capturista", "Tecnico", "Vendedor", " " }));
        cmb_niveles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmb_nivelesActionPerformed(evt);
            }
        });
        getContentPane().add(cmb_niveles, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 140, 30));
        ...
        getContentPane().add(jButton_Actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 210, 35));
        ...
        getContentPane().add(jButton_RestaurarPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 210, 35));
