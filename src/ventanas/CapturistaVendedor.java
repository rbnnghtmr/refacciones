 ...
 * @author Ernesto
 */
public class CapturistaVendedor extends javax.swing.JFrame {
    
    String user, nombre_usuario;
    int sesion_usuario;
    int permisos_cmb;

    public CapturistaVendedor() {
    ...
    private void btnRegresarAdministradorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarAdministradorActionPerformed
        ...
        ModuloVenta regresar = new ModuloVenta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturistaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturistaVendedor().setVisible(true);
            }
        });
    }
